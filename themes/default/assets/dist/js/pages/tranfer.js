...
function loadItems(trnsid) {
    ...
    if (get('tspoitems')) {
        ...
        $.each(tspoitems, function () {
            ...
            var product_id = item.row.id, store_qty = item.row.store_qty, SeqCount=item.row.SeqCount, SeqAll = item.row.SeqAll , sqtrans = item.row.sqtrans, item_cost = item.row.cost, item_qty = item.row.qty, sqtrans = item.row.sqtrans, item_code = item.row.code,
