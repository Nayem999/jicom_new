    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-lg-12">
                        <?php echo form_open_multipart("mf_purchases_packaging/edit/".$mf_purchase->id, 'class="validation edit-po-form"'); ?>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="poTable" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="active">
                                            <th class="col-xs-4"><?= lang('raw_material_packaging'); ?></th>
                        ...
                        <div class="form-group">
                            <?= form_submit('edit_purchase_packaging', lang('edit_purchase'), 'class="btn btn-primary" id="edit_purchase"'); ?>
...
<script src="<?= $assets ?>dist/js/pages/mf_purchases_packaging.js" type="text/javascript"></script>