...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content" >
        ...
        <div class="modal-header">
            ...
            <h4 id="myModalLabel" class="modal-title">lift profit list (<?php echo $emplyee->name ; ?>)</h4>
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered table-hover table-striped" id="CompTable">
                    ...
                    <tbody>
                            ...
                            <tr class="row<?php echo $i ; ?>">
                                ...
                                <td>
                                <a class="tip" data-toggle="ajax" onclick="editLiftPofit(<?php echo $value->liftprofit_id ; ?>)" href="javascript:;">
                                	<i class="fa fa-edit"></i>
                                </a>
                                <a class="tip" onclick="return confirm('You are going to delete paysalary, please click ok to delete.')" href="<?php echo site_url('partner/payProfitdelete/'.$value->liftprofit_id); ?>" title="Delete Payment">
