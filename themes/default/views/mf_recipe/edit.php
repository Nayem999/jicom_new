            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <?= form_input('description', set_value('description',$recipe_mst->description), 'class="form-control tip" id="description" '); ?>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <?= form_submit('edit_recipe', lang('edit_recipe'), 'class="btn btn-primary" id="edit_recipe"'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       store('recipe_items', JSON.stringify(<?= $recipe_dtls; ?>)); 
    });
