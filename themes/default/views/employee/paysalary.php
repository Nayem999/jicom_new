...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 id="myModalLabel" class="modal-title">Pay employee salary <?php if(isset($emplyee->name)){ echo '('.$emplyee->name.')'; } ?> </h4>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="month_id" class="form-control">
                        	<option value="" > Select </option>
                            <option value="01" <?php slectedMonth('01') ?> >January</option>
                            <option value="02" <?php slectedMonth('02') ?>>February</option>
                            <option value="03" <?php slectedMonth('03') ?>>March</option>
                            <option value="04" <?php slectedMonth('04') ?>>April</option>
                            <option value="05" <?php slectedMonth('05') ?>>May</option>
                            <option value="06" <?php slectedMonth('06') ?>>June</option>
                            <option value="07" <?php slectedMonth('07') ?>>July</option>
                            <option value="08" <?php slectedMonth('08') ?>>August</option>
                            <option value="09" <?php slectedMonth('09') ?>>September</option>
                            <option value="10" <?php slectedMonth('10') ?>>October</option>
                            <option value="11" <?php slectedMonth('11') ?>>November</option>
                            <option value="12" <?php slectedMonth('12') ?>>December</option>
