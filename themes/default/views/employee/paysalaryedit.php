                ...
                <div class="col-sm-6"> 
                    <div class="form-group">
                       ...
                       <select class="form-control select2 tip" name="type" required="required" id="type">
                         ...
                         <option value="cash" <?php if($paySalary->paid_by =='cash'){ echo 'selected';}?> >Cash</option>
                         <option value="cheque" <?php if($paySalary->paid_by =='cheque'){ echo 'selected';}?>>Cheque</option>
                         <option value="card" <?php if($paySalary->paid_by =='card'){ echo 'selected';}?>>Card</option>
                       </select>
                    </div>
                    <div id="bankInfo"></div>
                </div>
