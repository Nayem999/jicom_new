                            ...
                            <?php if ($Admin && $id != $this->session->userdata('user_id')) { ?>
                                ...
                                <?php if($user->group_id !=1){?>
                                    <div class="form-group"> 
                                        ...
                                        echo form_dropdown('store', $st, $user->store_id, 'id="store" data-placeholder="' . lang("select") . ' ' . lang("group") . '" class="form-control input-tip select2" style="width:100%;"');
                                        ?>
                                    </div>
                                <?php } else {?>
                                    <div class="form-group" id="storeInfo"></div>  
                                    <?php } ?>                     
                                <?php  } else { ?>
                                <input type="hidden" name="store" value="<?php echo $this->session->userdata('store_id'); ?>">
                                <?php } ?>  
...
<script>
    $(function(){
     $("#group").change(function(){ 
         ...
         var url = '<?php echo base_url('auth/storeInfo') ?>'+'/'+paymentType;          
         $('#storeInfo').load(url);         
        });
    });
</script>
