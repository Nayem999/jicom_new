        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <div class="text">
                    ...
                    <span style="text-align:center;">
                        ...
                        <p>
                        <h6><b>BIN Number:</b> <?= $settings->bin_number; ?></h6>
                        </p>
                    </span>
                    <div style="width:100%; font-size: 140%;">
                        <div style="width:48%; float:left;">
                            <p>
                                ...
                                ?>
                                    ...
                                    <?php if ($result->cf1) {
                                        echo '<strong> Address: </strong> ' . $result->cf1 . '<br>';
                                    } ?>
                                    <?php if ($result->cf2) {
                                        echo '<strong> Address: </strong> ' . $result->cf2 . '<br>';
                                    } ?>
                    ...
                    <table class="table table-bordered table-condensed" width="1000px">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $tax_summary = array();
                            $qnty_type = array(1 => "BUCKET", 2 => "CARTON", 3 => "CP CARTON", 4 => "CP BAG");
                            $warranty_year = '';
                            foreach ($rows as $row) {
                        ...
                        <td class="text-left">' . product_name($row->product_name);
                                ...
                                if ($row->qnty_type) {
                                    echo $qnty_type[$row->qnty_type] . " (" . $row->per_type_qnty . ")";
                                }
            ...
            if($tAdAmount > 0){  
              ...
              $tAdAmount = $tAdAmount-$inv->paid;              
                    ...
                    <!-- <div class="warranty" style="text-align:left; <?php if ($inv->warranty == 'Not') {
                                                                            echo  'display:none;';
                                                                        } ?> " >
            <?= $Settings->warranty; ?>
            </div>
