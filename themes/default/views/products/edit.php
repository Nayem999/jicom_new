                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <?= lang('Brands', 'Brands'); ?>
                                    <?php
                                    $ba[''] = lang("select")." ".lang("Brands");
                                    foreach($this->site->seleteQuery('brands') as $brands) {
                                        $ba[$brands->id] = $brands->name;
                                    }
                                    ?>
                                    <?= form_dropdown('brand', $ba, set_value('brand',$product->brands_id), 'class="form-control select2 tip" id="category"  required="required" style="width:100%;"'); ?>
                                </div>
