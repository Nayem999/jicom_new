...
<div class="modal-dialog">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= lang("date", "date"); ?>
                         <input name="date" type="text" id="date" value="<?php if($payinfo->date !=''){ echo $payinfo->date ;}else{ echo date('Y-m-d H:i') ; } ?>" class="form-control datetimepicker" required="required"/>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input('reference', set_value('reference',$payinfo->reference), 'class="form-control tip" id="reference"'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
								...
								?>
                                    ...
                                    <?php if($payinfo->paid_by !=''){ echo paid_type($payinfo->paid_by);}else{ ?>
    ...
    <div class="form-group">
        ...
        <?php echo form_textarea('note',$payinfo->note, 'class="form-control redactor" id="note"'); ?>
