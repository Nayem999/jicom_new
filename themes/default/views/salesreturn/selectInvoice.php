...
<div class="modal-dialog">
    ...
    <?php //print_r($pay_info); ?>
        ...
        <?= form_open_multipart("salereturn/add"); ?>
...
function invoiceValue(value) {
	  ...
	  var site_url = "<?php echo site_url('salereturn/ajaxValue'); ?>/" +inputString; 
	 $("#invoiceName").load(site_url);
}

function invoicProduct(id) {
	 var dataString = 'id='+ id ;
	 var site_url = "<?php echo site_url('salereturn/invoicProduct'); ?>/" +id; //append id at end
