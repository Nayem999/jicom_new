...
if ($modal) {
    ...
    <head>
        ...
        <style type="text/css" media="all">
            ...
            #wrapper { max-width: 660px; margin: 0 auto; padding-top: 0px; }
...
<div id="wrapper">
    ...
    <div id="receipt-data">   
        ...
        <div class="text">
                ...
                <p>
                <strong> Invoice No:</strong>  <?= $inv->sale_id; ?><br>
            ...
            if($warranty_year){
                ...
                echo '<tr><td colspan="5"> *Warranty Will Be Void Due To Burn, Physical Demange, Mishandaling & Naturanl Disester </td></tr>';
                 echo '</tbody></table>';
            }
