  ...
  <nav class="navbar navbar-static-top" role="navigation"> <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> 
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <?php } ?>
        <li class="dropdown user user-menu" style="padding-right:5px;"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?= base_url('uploads/avatars/thumbs/'.($this->session->userdata('avatar') ? $this->session->userdata('avatar') : $this->session->userdata('gender').'.png')) ?>" class="user-image" alt="Avatar" /> <span class="hidden-xs">
    ...
    <ul class="sidebar-menu"> 
     ...
     <li class="treeview mm_supplierpayment"> <a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>
       ...
       <li class="treeview mm_loan"> <a href="#"><i class="fa fa-credit-card" aria-hidden="true"></i>
        ...
        <ul class="treeview-menu"> 
          <li id="loan_list_loan"><a href="<?= site_url('loan/list_loan'); ?>"><i class="fa fa-circle-o"></i>List Loan</a></li>
     
          <li id="loan_pay_loan"><a href="<?= site_url('loan/pay_loan'); ?>"><i class="fa fa-circle-o"></i>
          <?= lang('Pay Against Loan'); ?>
          </li>
          <li id="loan_add_loan"><a href="<?= site_url('loan/add_loan'); ?>"><i class="fa fa-circle-o"></i>Add Loan</a></li>
       
          <li id="loan_index"><a href="<?= site_url('loan'); ?>"><i class="fa fa-circle-o"></i>List loan Giver</a></li>
      
          <li id="loan_add_loaner"><a href="<?= site_url('loan/add_loaner'); ?>"><i class="fa fa-circle-o"></i>Add Loan Giver</a></li> 

          <li id="loan_loan_report"><a href="<?= site_url('loan/loan_report'); ?>"><i class="fa fa-circle-o"></i>Loaner Report </a></li> 
        </ul>
      </li> 
...
<span>Bank Account</span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          ...
          <li id="bank_add"><a href="<?= site_url('bank/pendingCheque'); ?>"><i class="fa fa-circle-o"></i>Peding Cheque</a></li>
        </ul>
      </li>
