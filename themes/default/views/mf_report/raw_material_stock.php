...
<script type="text/javascript">
    ...
    $("#printWindow").click(function () {        
        ...
        var content = "<html> <br><p style='text-align:center'> <b class='box-title'>Raw Material  Stock list | <?= $this->Settings->site_name ?></b><br><b class='box-title'><p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;}td, th {border: 1px solid #dddddd;text-align: left;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
