    ...
    $('#chart2').highcharts({
        ...
        series: [{
            ...
            foreach($topProducts as $tp) {
                $product_name = str_replace("''",'',$tp->product_name);
                echo "['".$product_name." (".$tp->product_code.")', ".$tp->quantity."],";
                $product_name='';
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <a class="btn btn-app" href="<?= site_url('service'); ?>">

                        <i class="fa fa-shopping-cart"></i>Service
