            ...
            <div class="box box-primary">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <?= form_open("mf_categories/available_cat/"); ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a target="_black" href="<?php echo base_url("mf_categories/') . '/productListByCatId/' . $category->id ?>" class="tip btn btn-primary btn-xs" title="" data-original-title="Product List"> <i class="fa fa-list"></i>
...
<script type="text/javascript">
    function productList(id) {
        ...
        var site_url = "<?php echo site_url("mf_categories/productListByCatId'); ?>/" + id; //append id at end
