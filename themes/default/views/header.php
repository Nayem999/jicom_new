            ...
            <li class="treeview mm_reports"> <a href="#"> <i class="fa fa-bar-chart-o"></i> <span>
              ...
              <ul class="treeview-menu">
                <?php if ($this->site->route_permission('reports_view')) {?>
                  ...
                  <li id="reports_collection_rpt_without_pos"><a href="<?= site_url('reports/collection_rpt_without_pos'); ?>"><i class="fa fa-circle-o"> </i>Collection Report Without POS</a></li>
