<script>
    ...
    $(document).ready(function () {        
        $('#spData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('attachment/get_docs_list') ?>',
            ...
            "aoColumns": [null, null, null, null, {"mRender":attach,"bSortable":false}, null, null, null]
        });
    });
</script> 
