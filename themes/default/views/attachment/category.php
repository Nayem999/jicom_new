<script>
    ...
    $(document).ready(function () {        
        $('#spData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('attachment/get_category') ?>',
