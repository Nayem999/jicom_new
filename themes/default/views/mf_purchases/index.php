...
<script>
    $(document).ready(function() {
        ...
        $('#purData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('mf_purchases/get_purchases/' . $v) ?>',
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        ...
                        $tDueAmount    = $this->mf_purchases_model->purchasesAmount('deu');
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <th class="col-xs-7"><?php echo $this->tec->formatMoney($this->mf_purchases_model->purchasesAmount('total', NULL, NULL,$store_id)); ?></th>
                                    </tr>
                                    <tr>
                                        <th class="col-xs-5">Total Paid Amount</th>
                                        <th class="col-xs-7"><?php echo $this->tec->formatMoney($this->mf_purchases_model->purchasesAmount('paid', NULL, NULL,$store_id)); ?></th>
                                    </tr>
                                    <tr>
                                        <th class="col-xs-5">Total Due Amount </th>
                                        <th class="col-xs-7"><?php echo $this->tec->formatMoney($this->mf_purchases_model->purchasesAmount('deu', NULL, NULL, $store_id)); ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
