                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                   ...
                                   <label for="position">Position</label>
                                    ...
                                    <?= form_input('position', $settings->position, 'class="form-control" id="position" required="required"') ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('p_count', $ct, $settings->p_count, 'class="form-control select2" style="width:100%;" required="required"') ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?= lang('Uniq Code', 'Uniq Code'); ?>

                                    <?= form_input('uniqcode', $settings->uniqcode, 'class="form-control tip" id="default_email" required="required"'); ?>
                                ...
                                <div class="well well-sm">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="api_key" value="<?php echo $Settings->api_key; ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sender_id" value="<?php echo $Settings->sender_id; ?>" class="form-control">
                                        </div>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <div class="row ">
                            <div class="col-lg-12">
                                <div class="well well-sm">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="supplier_sms">Supplier Sms</label>
                                            <textarea name="supplier_sms" id="supplier_sms" class="form-control redactor" cols="30" rows="10"><?php echo $Settings->supplier_sms; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="customer_sms">Customer Sms</label>
                                            <textarea name="customer_sms" id="customer_sms" class="form-control redactor" cols="30" rows="10"><?php echo $Settings->customer_sms; ?></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="bill_footer">Warranty Information</label>
                                        
                                        <?= form_textarea('warranty', $settings->warranty, 'class="form-control redactor" id="warranty"'); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="bill_footer">Sarvice Information</label>
                                        
                                        <?= form_textarea('sarvice_info', $settings->sarvice_info, 'class="form-control redactor" id="sarvice_info"'); ?>
