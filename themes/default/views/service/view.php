...
<div id="wrapper" style="max-width: 700px;">
    ...
    <div id="receipt-data">
        ...
        <div class="text">
                ...
                <h4 style="text-align: center; margin: 0px 0px 0px 0px">Service Invoice</h4> 
     			<span style="float:left">
                <p>
                <?= lang("date").': '.$this->tec->hrld($service_info->date_submit); ?><br>
                <?= lang("customer").': '.$service_info->customer_name; ?> 
                </p>
                </span>
				<span style="float:right; font-weight: bold;">
                 Service invoice No: <?= $service_info->service_id; ?> <br>
                 invoice No: <?= $service_info->sale_id; ?>
                </span> 
