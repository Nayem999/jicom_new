                            ...
                            <tr class="row13">
                                ...
                                <td>
                                    ...
                                    <div class="text-center">
                                            ...
                                            <a data-toggle="ajax"  href='javascript:;' onClick="editSarvicePay('<?php echo $value->id ?>')" class="tip"><i class="fa fa-edit"></i></a>
                                            <a onclick="return confirm('You are going to delete payment, please click ok to delete.')" href="<?php echo site_url('service/delete_payment/'.$value->service_id.'/'.$value->id) ?>" title="Delete Payment" class="tip"><i class="fa fa-trash-o"></i></a>
