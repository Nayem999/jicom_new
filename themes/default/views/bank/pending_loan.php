...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#CuData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('bank/get_pending_loan') ?>',
...
<script type="text/javascript">
 ...
 $("#daily_sales").click(function () {        
    ...
    $("#fileData_filter ").css("display", "none");
     var content = "<html> <br><p style='text-align:center'> <b class='box-title'>Bank Loan Pending list |  <?php echo $this->Settings->site_name; ?></b><br><b class='box-title'><p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;}td, th {border: 1px solid #dddddd;text-align: left;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
