            ...
            <div class="box box-primary">
                ...
                <div class="table-responsive">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-md-6"> 
                        <?php echo form_open_multipart("mf_payment_packaging/today_payment", 'class="validation"'); ?>
                            ...
                            <div class="form-group">
                                <?= form_submit('add_purchase', lang('Packaging Payment'), 'class="btn btn-primary"'); ?>
...
<script>
    $(function(){
     $("#supplier").change(function(){
         ...
         var url = '<?php echo base_url('mf_payment_packaging/supplierInfo') ?>'+'/'+supplierId;
    ...
    $(function(){
     $("#type").change(function(){
        document.getElementById("bankInfo").innerHTML = "";
         ...
         var url = '<?php echo base_url('mf_payment_packaging/bankInfo') ?>'+'/'+paymentType+'/'+supplier_id;          
         $('#bankInfo').load(url);
