<div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="posModal" data-easein="flipYIn" class="modal posModal in" style="display: block; padding-left: 17px;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('mf_production/approve/' . $id); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <input id="paid_by" name="status" type="radio" class="" <?php if ($info->status == "Approved") echo "checked='checked'"; ?> value='Approved' />
                            <label for="paid_by" class="">Approved</label>

                            <input id="paid_by" name="status" type="radio" class="" <?php if (($info->status == "Pending")) echo "checked='checked'"; ?> value="Pending" />
