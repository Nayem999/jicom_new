                ...
                <div class="box-body">
                    <div id="form" class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <?= form_open("reports/collection_adjustment_rpt"); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="control-label" for="customer_id"><?= lang("Customer Name"); ?></label>
                                        <?php

                                        $cu[0] = lang("select") . " " . lang("Customer");
                                        foreach ($customer_arr as $key => $sname) {
                                            $cu[$sname->id] = $sname->name;
                                        }
                                        echo form_dropdown('customer_id', $cu, set_value('customer_id'), 'class="form-control select2" style="width:100%" id="customer_id"');
                                        ?>
                                    </div>
                                </div>
                                <div class="col-sm-3">
