<script>
    ...
    $(document).ready(function () {
        ...
        $('#CuData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('donations/get_pay_list') ?>',
                ...
                <div class="box-body" id="print_content">
                    ...
                    <table id="CuData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("Check or card no"); ?></th>
...
<script>
    ...
    var content = "<html> <br><img width='800px' src='<?= base_url('themes/default/assets/images/chalan.png'); ?>'><br><p style='text-align:center'>Persons or Organizations list | <?php echo $this->Settings->site_name; ?> </p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;}td, th {border: 1px solid #dddddd;text-align: left;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
