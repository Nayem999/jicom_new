<script>
    ...
    $(document).ready(function () {
        ...
        $('#CuData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('donations/get_donations_persons') ?>',
...
<script>
    ...
    var content = "<html> <br><img width='800px' src='<?= base_url('themes/default/assets/images/chalan.png'); ?>'><br><p style='text-align:center'>Persons or Organaizations list | <?php echo $this->Settings->site_name; ?> </p><style> table {font-family: arial, sans-serif;border-collapse: collapse;width: 100%;}td, th {border: 1px solid #dddddd;text-align: left;padding: 2px;} tr:nth-child(even) {background-color: #dddddd;} </style>";
