    ...
    function login($m = NULL) { 
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
                ...
                $userinfo =  $this->site->getUser($this->session->userdata('user_id'));
    ...
    function create_user() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $additional_data = array(
                ...
                'store_id' => $this->input->post('store') ? $this->input->post('store') : $this->session->userdata('store_id'),
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            if ($this->Admin) {
                if($id == $this->session->userdata('user_id')) {
                    ...
                    if($this->input->post('group') !='1'){
                        $data['store_id'] = $this->input->post('store') ? $this->input->post('store') : $this->session->userdata('store_id');
                    } else {
                       $data['store_id'] = 0; 
                    }
                }
